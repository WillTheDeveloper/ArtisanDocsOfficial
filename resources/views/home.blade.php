    ...
    <div class="relative pt-6 pb-16 sm:pb-24">
        <div>
            ...
            {{--<span class="inline-flex rounded-md shadow">
              <a href="#" class="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md text-amber-500 bg-white hover:bg-gray-50">
                Log in
              </a>
            </span>--}}
                    </div>
            ...
            <div class="absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
                <div class="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
                    ...
                    <a href="#" class="block w-full px-5 py-3 text-center font-medium text-amber-500 bg-gray-50 hover:bg-gray-100">
                        Log in
                    </a>
                </div>
            </div>
        ...
        <main class="mt-16 mx-auto max-w-7xl px-4 sm:mt-24">
            <div class="text-center">
                ...
                <p class="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
                    A place where you can get easy to follow documentation for everything you need to know to create an awesome web based platform. <br> All the following docs are unofficial and were written by me.
                </p>
